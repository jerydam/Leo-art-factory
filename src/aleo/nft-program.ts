export const NFTProgramId = 'privacy_NFT_CyberhackB';

export const NFTProgram = `program privacy_NFT_CyberhackB;
...
function initialize_collection:
    ...
    assert.eq self.caller aleo1yjgnsrcasfw2pn3mjneh4ke72nxp0gkrz2cwwtes44wgwet47qgsu7z69a;
    async initialize_collection r0 r1 r2 into r3;
    output r3 as privacy_NFT_CyberhackB/initialize_collection.future;
...
function add_nft:
    ...
    output r4 as privacy_NFT_CyberhackB/add_nft.future;
...
function add_minter:
    ...
    output r3 as privacy_NFT_CyberhackB/add_minter.future;
...
function update_toggle_settings:
    ...
    output r1 as privacy_NFT_CyberhackB/update_toggle_settings.future;
...
function set_mint_block:
    ...
    output r1 as privacy_NFT_CyberhackB/set_mint_block.future;
...
function update_symbol:
    ...
    output r1 as privacy_NFT_CyberhackB/update_symbol.future;
...
function update_base_uri:
    ...
    output r1 as privacy_NFT_CyberhackB/update_base_uri.future;
...
function open_mint:
    ...
    output r4 as privacy_NFT_CyberhackB/open_mint.future;
...
function mint:
    ...
    output r7 as privacy_NFT_CyberhackB/mint.future;
...
function claim_nft:
    ...
    output r6 as privacy_NFT_CyberhackB/claim_nft.future;
...
function authorize:
    ...
    output r2 as privacy_NFT_CyberhackB/authorize.future;
...
function transfer_public:
    ...
    output r5 as privacy_NFT_CyberhackB/transfer_public.future;
...
function convert_private_to_public:
    ...
    output r3 as privacy_NFT_CyberhackB/convert_private_to_public.future;
...
function convert_public_to_private:
    ...
    output r5 as NFT.record;
    output r6 as privacy_NFT_CyberhackB/convert_public_to_private.future;
